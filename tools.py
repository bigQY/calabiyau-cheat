...
class KlbqV10:
  def __init__(self,weight_path=r'S:\code\klbq\best.pt'):
...
class Detector:
    def __init__(self, weights=r'S:\code\klbq\best_openvino_model'):
        self.model = AutoBackend(weights,device=[0],fp16=True)
    def detect(self,image):
